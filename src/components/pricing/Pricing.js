...
import "./pricing.css";
import Avatar1 from "../../assets/price-1.svg";
import Avatar2 from "../../assets/price-2.svg";
import Avatar3 from "../../assets/price-3.svg";
const Pricing = () => {
  return (
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          <img src={Avatar1} alt="" className="pricing__img" />
          <h3 className="pricing__plant">Basic</h3>
        ...
        <div className="pricing__item best">
          ...
          <img src={Avatar2} alt="" className="pricing__img" />
          <h3 className="pricing__plant">Premium</h3>
          <p className="pricing__title">
        ...
        <div className="pricing__item">
          <img src={Avatar3} alt="" className="pricing__img" />
          <h3 className="pricing__plant">Ultimate</h3>
          <p className="pricing__title">
